\documentclass[10pt,a4paper]{book}	% Tipo de documento con letra a 10pt y papel A4
...
\usepackage[margin = 2cm, headsep = 10pt]{geometry}	% Dimensiones del documento
\usepackage{nameref}
...
\usepackage[framemethod=default]{mdframed}					    % Sirve para encerrar los teoremas de amsthm en cajas para darle un estilo más personalizado
...
\usepackage{thmtools}
\usepackage{nicematrix}           % Matrices y tablas bonitas 
%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{titlesec}					% Para poder personalizar el estilo de los capítulos, secciones, subsecciones, etc.
